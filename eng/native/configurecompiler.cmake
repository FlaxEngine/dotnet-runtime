...
if (MSVC)
  ...
  if(_GAMING_XBOX)
  message("Build native/configurecompiler.cmake for Xbox")
...
if (CLR_CMAKE_HOST_UNIX)
  ...
  elseif(NOT CLR_CMAKE_HOST_BROWSER AND NOT CLR_CMAKE_HOST_WASI AND NOT CLR_CMAKE_HOST_SWITCH)
...
if(CLR_CMAKE_TARGET_UNIX)
  ...
  elseif(CLR_CMAKE_TARGET_PS4)
    add_compile_definitions($<$<NOT:$<BOOL:$<TARGET_PROPERTY:IGNORE_DEFAULT_TARGET_OS>>>:TARGET_PS4>)
    unset(CMAKE_C_STANDARD)
    unset(CMAKE_CXX_STANDARD)
  elseif(CLR_CMAKE_TARGET_PS5)
    add_compile_definitions($<$<NOT:$<BOOL:$<TARGET_PROPERTY:IGNORE_DEFAULT_TARGET_OS>>>:TARGET_PS5>)
    unset(CMAKE_C_STANDARD)
    unset(CMAKE_CXX_STANDARD)
  elseif(CLR_CMAKE_TARGET_SWITCH)
    add_compile_definitions($<$<NOT:$<BOOL:$<TARGET_PROPERTY:IGNORE_DEFAULT_TARGET_OS>>>:TARGET_SWITCH>)
    unset(CMAKE_C_STANDARD)
    unset(CMAKE_CXX_STANDARD)
