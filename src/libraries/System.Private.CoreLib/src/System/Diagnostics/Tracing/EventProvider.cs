...
#pragma warning restore CA1823, CS0169, IDE0051
    ...
    internal sealed class EventProvider : IDisposable
    {
        ...
        // <ReferencesCritical Name="Method: EtwEnableCallBack(Guid*, Int32, Byte, Int64, Int64, Void*, Void*):Void" Ring="1" />
        // </SecurityKernel>
        internal static unsafe void Register(EventSource eventSource)
        {
        }
        ...
        private static void OnControllerCommand(ControllerCommand command, IDictionary<string, string?>? arguments, int sessionId, int etwSessionId) { }
        ...
        private EventKeywords MatchAnyKeyword
        {
            get => (EventKeywords)m_anyKeywordMask;
            set => m_anyKeywordMask = unchecked((long)value);
        }

        private EventKeywords MatchAllKeyword
        {
            get => (EventKeywords)m_allKeywordMask;
            set => m_allKeywordMask = unchecked((long)value);
        }
